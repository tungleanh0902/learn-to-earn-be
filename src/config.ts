...
export const tonQuery = axios.create({
    baseURL: 'https://testnet.tonapi.io/v2/traces/'
    // baseURL: 'https://tonapi.io/v2/traces/'
  });
// testnet
export const TON_CENTER_RPC = "https://testnet.toncenter.com/api/v2/jsonRPC"
export const TON_CENTER_API = "https://testnet.toncenter.com/api/v3/transactionsByMessage"
...
export const SAVE_STREAK_FEE_EVM = "2000000000000000000" // 0.2 Kaia
export const MORE_QUIZZ_FEE_EVM = "4000000000000000000" // 0.4 Kaia
export const MINT_NFT_FEE_EVM = "4000000000000000000" // 4 Kaia

// mainnet
// export const TON_CENTER_RPC = "https://toncenter.com/api/v2/jsonRPC"
// export const TON_CENTER_API = "https://toncenter.com/api/v3/transactionsByMessage"
...
// export const BUY_VOUCHER = 500000000 // 0.5 TON
...
// export const MORE_QUIZZ_FEE_EVM = "1000000000000000000" // 1 Kaia
